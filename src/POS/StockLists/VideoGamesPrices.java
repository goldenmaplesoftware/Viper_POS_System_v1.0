...
public class VideoGamesPrices<ElementPosition,GameTitle>
{
    private ElementPosition  indexPosition;
    private GameTitle title;

public VideoGamesPrices(ElementPosition element, GameTitle title)
{
    ...
    public void setQuantity(ElementPosition i) {
    }
}
